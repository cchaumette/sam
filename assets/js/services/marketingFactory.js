 ...
 */
app.factory('marketing', function() {
  console.log("===factory.marketing==");
  var marketing = {};
  marketing.data =
  {
  ...
  marketing.get = function(RecordKey) {
    for (var i = 0; i < marketing.data.MarketingInfo.length; ++i) {
      if(marketing.data.MarketingInfo[i].RecordKey === RecordKey && marketing.data.MarketingInfo[i].Language === "en"){
        return marketing.data.MarketingInfo[i];
      }
    }
    return null;
  };
