...
app.factory('policy', function() {
  ...
  var policy =
  {
    ...
    param :
    {
      ...
      "NumberOfClaims" : [{label : '0', value :'0'},{label : '1', value :'1'},{label : '2', value :'2'},{label : '> 2', value :'3'}],
      "NumberOfWindscreenClaims" : [{label : '0', value :'0'},{label : '1', value :'1'},{label : '2', value :'2'},{label : '> 2', value :'3'}],
